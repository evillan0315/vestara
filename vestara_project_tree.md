...
│       ├── vestara-dark.json
│       ├── vestara-light.json
│       └── vestara-midnight.json
├── opencode.json
├── PHASE-3-HANDOFF.md
├── PRODUCT-BACKLOG.md
├── PRODUCT-CHARTER.md
├── PRODUCT-ENGINEERING-CHARTER.md
├── PRODUCT-PRINCIPLES.md
├── README.md
├── thoughts
│   └── plans
│       └── epic-001-repository-comprehension.md
├── .vestara
│   ├── knowledge
│   │   └── chunks.db
│   ├── memory
...
│   │   │   └── last.session.json
│   │   └── workspace.json
│   ├── VESTARA_AI_OS_PROJECT_STRUCTURE.md
│   ├── vestara-state.db
│   └── vitest.config.ts
├── vestara-blueprint
│   ├── 00-governance
...
│   │   ├── 03-ai-development-lifecycle.md
│   │   ├── 04-decision-log.md
│   │   ├── 05-compatibility.md
│   │   ├── 06-ai-development-framework.md
│   │   └── README.md
│   ├── 01-company
...
│   ├── README.md
│   ├── runtime-contracts
│   │   └── VESTARA-RUNTIME-ARCHITECTURE.md
│   ├── sdk-interfaces
│   ├── service-contracts
│   │   └── SERVICE-CATALOG.md
│   ├── shared-schemas
...
│   │   └── PLATFORM-ENGINEERING-GOVERNANCE.md
│   ├── boot
│   ├── configuration
...
│   ├── ai-capabilities
│   │   └── AI-CONTRACT-INDEX.md
│   ├── apis
│   │   ├── API-CONTRACT-INDEX.md
│   │   └── PLATFORM-API.md
│   ├── capabilities
│   │   ├── CAP-001-workspace-chat.md
│   │   └── INDEX.md
│   ├── data-models
│   │   └── DATA-DICTIONARY.md
│   ├── decision-registry
...
│   ├── validation
│   │   └── blueprint-validation-cli.md
│   └── workflows
└── vite.config.ts

404 directories, 1568 files
